...
namespace NetworKit {
        ...
        Centrality::Centrality(const Graph &G, bool normalized, bool computeEdgeCentrality, edgeweight _K)
                : Algorithm(), G(G), normalized(normalized), computeEdgeCentrality(computeEdgeCentrality), __k_dist(_K) {
